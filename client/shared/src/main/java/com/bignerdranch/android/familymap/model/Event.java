...
public class Event implements Comparable<Event>{
    ...
    public int compareTo(Event event) {
        ...
        else if(this.getEventType().equals("birth")){
            return -1;
        }
        else if(event.getEventType().equals("death")) {
            return -1;
        }
        else if(this.getEventType().equals("death")){
            return 1;
        }
        if(!event.getYear().equals(null) || !this.getYear().equals(null)) {
            Integer first = Integer.parseInt(event.getYear());
            Integer second = Integer.parseInt(this.getYear());
            if (first == second) {
                return 0;
